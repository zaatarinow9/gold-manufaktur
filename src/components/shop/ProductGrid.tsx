      ...
      <div className="container-shell">
        <div className="content-shell space-y-8">
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="rtl-mirror-grid grid gap-6 overflow-hidden rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(22,18,13,0.92),rgba(9,9,9,0.96))] lg:grid-cols-[0.78fr_1fr]">
